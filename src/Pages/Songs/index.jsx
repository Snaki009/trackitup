...
const sortByFilters = (ar, br, diff, details, mode, sort) => {
    const a = ar[1].diffs.find(v => v.diff === diff)
    const b = br[1].diffs.find(v => v.diff === diff)
    switch (sort) {
        case 'tier':
            if (a === "?") return -1
            if (a.adiff < b.adiff)
...
const Songs = ({mode}) => {
    ...
    const shouldDisplayDiff = (diff) => {
        ...
        if(!Object.values(tags).some(a=>a)) {
            result = true
        } else {
                        ...
                        >
                            ...
                            <AccordionDetailsStyled>
                                ...
                                data[diff]
                                    ...
                                    const adiff = chartData.diffs.find(a => a.diff === diff).adiff
